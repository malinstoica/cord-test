...
describe("Rule checker middlware", () => {
    ...
    describe("/search endpoint", () => {
        ...
        it("should throw an error when calling get /member with a payload that has invalid nested types", () => {
            //Given
            mockRequest.originalUrl = API_ENDPOINTS.search;
            mockRequest.method = "GET";
            mockRequest.query = API_REQUESTS_DATA.invalidSearchRequestWrongNestedType.query;
